...
export const fetchStock =(id) => API.get(`/stock/${id}`)
export const addStock =( stock ) => API.post('/stock', stock)
export const updateStock = (id, updatedStock) => API.patch(`/stock/${id}`, updatedStock)
export const deleteStock =(id) => API.delete(`/stock/${id}`)
export const fetchStocksByUser = (searchQuery) => API.get(`/stock?searchQuery=${searchQuery.search}`);
